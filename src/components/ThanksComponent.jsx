  ...
  return (
    <div className="w-full h-full flex flex-col items-center">
      <img
        ...
        alt="thanks"
      />
      <div className="px-4 py-2 rounded-3xl bg-[#252d37] lg:mt-5">
        <h1 className="text-orange font-bold">
          You selected {selected} out of 5
        </h1>
      </div>
      <h1 className="text-white text-center lg:mt-5 lg:text-3xl font-bold">
        Thank you!
      </h1>
      <p className="text-center text-light-gray lg:mt-4">
